      ...
      <div className="ca-content">
        ...
        <section id="teaching-tools" className="ca-teaching" aria-labelledby="teaching-heading">
          ...
          <div className="ca-tools">
            {onOpenLessonBuilder && <button type="button" onClick={onOpenLessonBuilder} className="ca-tool min-h-11" aria-label="Create a lesson from slides and objectives"><BookOpen size={22} aria-hidden="true" /><span><strong>Create a lesson</strong><small>PowerPoint + learning objectives</small></span><ArrowRight size={18} aria-hidden="true" /></button>}
